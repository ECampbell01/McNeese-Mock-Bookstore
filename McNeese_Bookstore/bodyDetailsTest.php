    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="book-info">
                ...
                <?php
                    function addToCart($userId,  $price,$bookId = null, $supplyId = null )
                    {
                        $sqlStatement = 'INSERT INTO Cart(CustomerId, BookId, SupplId, TotalCost)
                        VALUES(?,?,?,?)';
                        $stmt = mysqli_prepare($conn, $sqlStatement);
                        mysqli_stmt_bind_param($stmt, "iiid", $userId, $bookId, $supplyId, $price);
                    ...
                    { 
                        $id = session_id();
                        addToCart(1, $book["Price"], $book_id, null );
                    } 
                ?>
